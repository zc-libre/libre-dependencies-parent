...
public class IpAddress {
	...
	/*
	 * Converts IPv4 address in its textual presentation form into its numeric binary
	 * form.
	 *
	...
	/*
	 * Convert IPv6 presentation level address to network order binary form. credit:
	 ...
	 * @return a String representing an IPv6 address in textual representation format
	 */
