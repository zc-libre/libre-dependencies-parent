 ...
 * @date 2023/6/28
 */
public class Oauth2CustomOAuth2AccessTokenResponseHttpMessageConverter
		extends OAuth2AccessTokenResponseHttpMessageConverter implements ApplicationContextAware {
