...
import static com.libre.toolkit.core.StringPool.DASH;
import static com.libre.toolkit.core.StringPool.EMPTY;
...
public class MqttAutoConfiguration {
	...
	private String getClientId(Environment environment) {
		...
		return applicationName + DASH + UUID.randomUUID().toString().replace(DASH, EMPTY);
	}
