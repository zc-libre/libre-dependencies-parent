...
//
// @Bean
// public RedissonSpringLocalCachedCacheManager cacheManager(RedissonCacheProperties
// properties) {
// RedissonSpringLocalCachedCacheManager cacheManager = new
// RedissonSpringLocalCachedCacheManager(redissonClient,
// getCacheConfig(properties.getGlobal()), buildCacheConfigMap(properties.getConfig(),
// redisNameResolver));
...
// }
// LocalCachedMapOptions<Object, Object> cacheConfig =
// getCacheConfig(configEntry.getValue());
...
// }
//
// private static LocalCachedMapOptions<Object, Object> getCacheConfig(RedissonCacheConfig
// config) {
