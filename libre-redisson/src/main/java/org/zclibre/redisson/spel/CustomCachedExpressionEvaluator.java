 ...
 * @author L.cm
 */
public class CustomCachedExpressionEvaluator extends org.springframework.context.expression.CachedExpressionEvaluator {
	...
	public EvaluationContext createContext(Method method, Object[] args, Object target, Class<?> targetClass,
		...
		CachedExpressionRootObject rootObject = new CachedExpressionRootObject(method, args, target, targetClass,
				targetMethod);
